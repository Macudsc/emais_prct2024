...
#    medical_record = models.ForeignKey(MedicalRecord, related_name='images', on_delete=models.CASCADE)
#    image_id = models.CharField(max_length=255)
#    uploaded_at = models.DateTimeField(auto_now_add=True)

#    def __str__(self):
#        return f'Image for record {self.medical_record.id} uploaded at {self.uploaded_at}'